...
function initFlywheel() {
  ...
  /* Add a “You” label sitting on the pre-filled green quadrant of the
     ring (mobile only) — psychological anchor that the buyer is already
     the fourth piece in place. Empirically the auto-opened arc renders
     on the LEFT side of the wheel (~9 o’clock midpoint), so we sit
     “You” directly on the arc there. Deep black for max contrast on the
     saturated green stroke (per user 2026-08-12). */
