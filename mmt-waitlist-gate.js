...
const LOCKS = [
  ...
  { id: 'software', label: 'Software', hue: GRN, pain: 'Missing opportunities', fix: '<span class="d-desktop">Proprietary software scanning markets 24/7.</span><span class="d-mobile">Scans the market 24/7.</span>' },
...
function initProfitTarget() {
  ...
  function render() {
    ...
    if (rate)  rate.innerHTML = 'USD per working day<br /><span class="pt-hero-rate">current rate ' + AUD_USD_RATE.toFixed(4) + ' AUD/USD</span>';
  }
